Algoritmo Liquidacion_Sueldo_Basico
	...
	Repetir
		...
		Si largoSueldoBase > 0 Entonces //Validaci�n para que incluso ingresando un valor vac�o (ENTER), vuelva a solicitar ingresar un monto
			esValorCorrecto <- ValidaNumeros(sueldoBase, largoSueldoBase, esValorCorrecto) //Si retorna falso, siempre se repetira el ciclo, si no retorna Falso, se mantendr� Verdadero y terminar� el ciclo
